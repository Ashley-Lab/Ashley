...
resposta_quando = [
    ...
    "meio seculo atraz",
    "já faz um bom tempo",
    "talvez quando ursos voarem",
    "quando você criar vergonha na cara",
    "você nem pensava em nascer",
    "daqui a algum distante tão longinco tempo",
    "quase na epoca dos dinosauros",
    "quando houver galinhas robotrons",
    "bom, é de me trazer nostalgia",
    "provavelmente quando os seus bisnetos terem bisnetos",
    "tenho cara de google?",
    "quando alguém com tempo de sobra fazer",
    "você estava dormindo quando aconeceu",
    "no mesmo dia em que eu nasci",
    "no mesmo dia que ele morreu",
    "quando isso não acontece?",
    "quando zeus quiser",
    "quando você morrer"]

resposta_onde = [
    "abaixo da terra provaelmente",
    "caido em alguma vala",
    "no mesmo lugar onde nasceu",
    "te caçando talvez",
    "virando a direita... ou esquedar?",
    "no meu bolso que não foi",
    "pergunta no posto ipiranga",
    "debaixo do meu tapete",
    "voando por ai",
    "quem vai saber?",
    "já faz algum tempo que isso aconteceu",
    "a esquerda do presidente",
    "ao lado do seu tumulo",
    "em cima de você é que não é",
    "tenho cara de adivinho?",
    "em algum lugar escondido",
    "provavelmente se perdeu",
    "ele já esta voltando de onde não deveria ter saido",
    "guadado?",
    "fique a vontade para pensar sobre isso"]
